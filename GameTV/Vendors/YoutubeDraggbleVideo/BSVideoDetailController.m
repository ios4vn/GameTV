...
- (UITableViewCell *)tableView:(UITableView *)theTableView cellForRowAtIndexPath:(NSIndexPath *)indexPath
{
    if (indexPath.section == ( _isLive ? 0 : 2)) {
        ...
        _webViewDisplay = [[UIWebView alloc] initWithFrame:CGRectMake(5.0f, 0.0f, 320.0f, [self minHeightForText:[_videoDetail objectForKey:@"summary"]])];
